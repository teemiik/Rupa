...
public class Level2 extends Game implements ContactListener, Screen {
    ...
    public Level2(final Intro intro) {
        this.intro = intro;
    ...
    public void render(float delta) {
        ...
        if (!faild)
            intro.setScreen(new TryContinueEnd(intro, 2));
        else if (win)
            intro.setScreen(new TryContinueEnd(intro, 2));
        else {
    ...
    private void getLvl() {
        ...
        box_hole.setTransform((float) (w_world * 0.28), (float) (h_world * 0.16 * 1.5), 0);
        ...
        hole1.setX((float) (w_world * 0.28 - hole_image.getTextureData().getHeight() / 2));
        hole1.setY((float) (h_world * 0.16 * 1.5 - hole_image.getTextureData().getHeight() / 2));

        ////////////////////////--------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.7 * 0.7), (float) (h_world * 0.31), 0);
        box_hole.setUserData("hole");

        hole2 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole2.setX((float) (w_world * 0.7 * 0.7 - hole_image.getTextureData().getHeight() / 2));
        hole2.setY((float) (h_world * 0.31 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.7 * 0.9), (float) (h_world * 0.16 * 1.7), 0);
        box_hole.setUserData("hole");

        hole3 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole3.setX((float) (w_world * 0.7 * 0.9 - hole_image.getTextureData().getHeight() / 2));
        hole3.setY((float) (h_world * 0.16 * 1.7 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.7 * 1.1), (float) (h_world * 0.16 * 2.2), 0);
        box_hole.setUserData("hole");

        hole4 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole4.setX((float) (w_world * 0.7 * 1.1 - hole_image.getTextureData().getHeight() / 2));
        hole4.setY((float) (h_world * 0.16 * 2.2 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.14), (float) (h_world * 0.16 * 2.45), 0);
        box_hole.setUserData("hole");
        ...
        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.35), (float) (h_world * 0.16 * 2.7), 0);
        box_hole.setUserData("hole");

        hole6 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole6.setX((float) (w_world * 0.35 - hole_image.getTextureData().getHeight() / 2));
        hole6.setY((float) (h_world * 0.16 * 2.7 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.7 * 0.7), (float) (h_world * 0.16 * 2.7), 0);
        box_hole.setUserData("hole");

        hole7 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole7.setX((float) (w_world * 0.7 * 0.7 - hole_image.getTextureData().getHeight() / 2));
        hole7.setY((float) (h_world * 0.16 * 2.7 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.7 * 0.9), (float) (h_world * 0.84 * 0.61), 0);
        box_hole.setUserData("hole");

        hole8 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole8.setX((float) (w_world * 0.7 * 0.9 - hole_image.getTextureData().getHeight() / 2));
        hole8.setY((float) (h_world * 0.84 * 0.61 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.7 * 1.1), (float) (h_world * 0.47), 0);
        box_hole.setUserData("hole");
        ...
        hole9.setY((float) (h_world * 0.47 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.56), (float) (h_world * 0.84 * 0.7), 0);
        box_hole.setUserData("hole");

        hole10 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole10.setX((float) (w_world * 0.56 - hole_image.getTextureData().getHeight() / 2));
        hole10.setY((float) (h_world * 0.84 * 0.7 - hole_image.getTextureData().getHeight() / 2));


        //11-20
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.7 * 0.3), (float) (h_world * 0.55), 0);
        box_hole.setUserData("hole");

        hole11 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole11.setX((float) (w_world * 0.7 * 0.3 - hole_image.getTextureData().getHeight() / 2));
        hole11.setY((float) (h_world * 0.55 - hole_image.getTextureData().getHeight() / 2));

        ////////////////////////--------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.7 * 1.1), (float) (h_world * 0.66), 0);
        box_hole.setUserData("hole");

        hole12 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole12.setX((float) (w_world * 0.7 * 1.1 - hole_image.getTextureData().getHeight() / 2));
        hole12.setY((float) (h_world * 0.66 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.35), (float) (h_world * 0.66), 0);
        box_hole.setUserData("hole");

        hole13 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole13.setX((float) (w_world * 0.35 - hole_image.getTextureData().getHeight() / 2));
        hole13.setY((float) (h_world * 0.66 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.42), (float) (h_world * 0.78), 0);
        box_hole.setUserData("hole");

        hole14 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole14.setX((float) (w_world * 0.42 - hole_image.getTextureData().getHeight() / 2));
        hole14.setY((float) (h_world * 0.78 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.56), (float) (h_world * 0.74), 0);
        box_hole.setUserData("hole");

        hole15 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole15.setX((float) (w_world * 0.56 - hole_image.getTextureData().getHeight() / 2));
        hole15.setY((float) (h_world * 0.74 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.83), (float) (h_world * 0.82), 0);
        box_hole.setUserData("hole");

        hole16 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole16.setX((float) (w_world * 0.83 - hole_image.getTextureData().getHeight() / 2));
        hole16.setY((float) (h_world * 0.82 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.7), (float) (h_world * 0.82), 0);
        box_hole.setUserData("hole");

        hole17 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole17.setX((float) (w_world * 0.7 - hole_image.getTextureData().getHeight() / 2));
        hole17.setY((float) (h_world * 0.82 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.7 * 0.3), (float) (h_world * 0.86), 0);
        box_hole.setUserData("hole");

        hole18 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole18.setX((float) (w_world * 0.7 * 0.3 - hole_image.getTextureData().getHeight() / 2));
        hole18.setY((float) (h_world * 0.86 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.56), (float) (h_world * 0.94), 0);
        box_hole.setUserData("hole");

        hole19 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole19.setX((float) (w_world * 0.56 - hole_image.getTextureData().getHeight() / 2));
        hole19.setY((float) (h_world * 0.94 - hole_image.getTextureData().getHeight() / 2));

        ///////////////////////---------------------------------------------------------------------
        box_hole = new BoxHole().createBoxHole(world);
        box_hole.setTransform((float) (w_world * 0.42), (float) (h_world * 0.9), 0);
        box_hole.setUserData("hole");

        hole20 = new Sprite(hole_image, hole_image.getTextureData().getHeight(), hole_image.getTextureData().getHeight());
        hole20.setX((float) (w_world * 0.42 - hole_image.getTextureData().getHeight() / 2));
        hole20.setY((float) (h_world * 0.9 - hole_image.getTextureData().getHeight() / 2));
